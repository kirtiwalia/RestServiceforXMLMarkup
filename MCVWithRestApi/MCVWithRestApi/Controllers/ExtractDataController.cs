using MCVAppWithRestApi.Models.ExtractData;
using MCVAppWithRestApi.Helpers;
using System;
using System.Collections.Generic;
using System.Web.Http;

namespace MCVWithRestApi.Controllers
{
    public class ExtractDataController : ApiController
    {
        ...
        /// <summary>
        /// Retrieves data for Expense Claim and Reservations from Markups present in the provided text.
        /// </summary>
        /// <param name="emailText">Text provided including the markup information</param>  
        /// <returns>Extracted Data Details of the Expense Claim and/or details of Reservations</returns>
        [HttpGet]
